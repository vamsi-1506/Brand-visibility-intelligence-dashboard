...
# ============================================================
    ...
    with col2:
        ...
        if not review_rank.empty:
            ...
            min_p = review_rank["price"].min()
            max_p = review_rank["price"].max()
            ...
            if (
                ...
                review_rank["bubble_size"] = (
                    (
                        review_rank["price"] - min_p
                    )
                    /
                    (max_p - min_p)
                    *
...
# ============================================================
    ...
    st.caption(
        ...
        f"Matching records: {len(explorer_df):,}"
    )
